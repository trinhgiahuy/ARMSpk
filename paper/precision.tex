...
\iftoggle{inclIEEECopyRight}{
    ...
    \newline\newline\newline\newline
    \textcopyright~2019 IEEE. Personal use of this material is permitted.
    ...
    \newline\newline\newline\newline
    {\large Accepted to be Published in: Proceedings of the 33rd IEEE
    International Parallel \& Distributed Processing Symposium, May 20-24,
...
\input{20-systems-and-app}
% 1.5 page

\input{30-methodology}
% 1.5 page

\input{40-eval-incl-result-summary}
% 2.5 -- 3 pages

\input{50-discussion-and-outlooks}
% 1 page

\input{60-related-work}
% 1/2 page
