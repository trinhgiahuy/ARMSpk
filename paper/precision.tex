...
\input{Systems-and-applications}
...
\input{evaluation-incl-result-"summary"}
% 2.5 -- 3 pages
...
% total #flops
% memory usage
% resource stall counter
% LLC hit/miss rate
% fp64/fp32/int/(branch?)/(unconditional memory ops; -> LOAD/STORE) instructions
% power usage
% memory-boundness, multitude of tests based on:
%  - educated guess
%  - roofline
%  - stalled instructions
%  - frequ. scaling
%  - mcdram? vs ddr?
%  - traffic betw. LLC and RAM
...
\input{discussion-on-implications-and-outlooks}
% 1 page
...
\bibliography{IEEEabrv,precision}
%
